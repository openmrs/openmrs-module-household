 ...
 * 
 * @see HouseholdEncounterType
 */
public class HouseholdEncounterTypeEditor extends PropertyEditorSupport {
	
	private Log log = LogFactory.getLog(this.getClass());
	
	public HouseholdEncounterTypeEditor() {
	}
	...
	public String getAsText() {
		HouseholdEncounterType t = (HouseholdEncounterType) getValue();
