package org.openmrs.module.household.exception;

import org.openmrs.api.APIException;


public class HouseholdModuleException extends APIException {
	 ...
	 */
	public HouseholdModuleException() {
	}
	 ...
	 */
	public HouseholdModuleException(String message) {
		super(message);
	}
	 ...
	 */
	public HouseholdModuleException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause the parent exception cause that this AddressHierarchyModuleException is wrapping around
	 */
	public HouseholdModuleException(Throwable cause) {
		super(cause);
	}
}
