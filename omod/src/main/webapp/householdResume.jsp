...
f.marktext.value = temparr.join(',');
 if(!document.checkedForm.marktext.value=='')
        document.checkedForm.resumeMembers.disabled=false;
else
        document.checkedForm.resumeMembers.disabled=true; 
}
}
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <c:choose>
                          ...
                          <input type="hidden" name="householdgrpRef" value="${householdGrp}" />
                </table>
                        ...
                        <table border="0" id="mytable"" cellpadding="0" cellspacing="5">
                                ...
                                <table>
                                        ...
                                        <tr>
                                                                ...
                                                                <td>&nbsp;</td>        
                                                                <td><input type="submit" name="resumeMembers" id="resumeMembers" onClick="return inputValidatorResumeReason()" value="Resume Care" disabled="disabled"/></td>
                                                                <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                                  <td>
                                                  ...
                                                  <a href="householdRegistration.form?grpid=${householdGrp}">Add Members</a>
                                                          </c:when>
                                                          <c:otherwise>
